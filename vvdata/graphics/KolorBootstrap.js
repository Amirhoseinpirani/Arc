...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'vvdata/vv_messages_','.xml');
	krpanoLoaded = true;
	...
	addKolorBox('webVideoViewer2');
addKolorBox('webVideoViewer1');
...
deleteKolorBox('webVideoViewer1');
deleteKolorBox('webVideoViewer2');
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'vvdata/vv_messages_','.xml');
}
...
function addKolorBox(pPlugID)
{
	...
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"vvdata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"vvdata/graphics/KolorBox/KolorBox.min.js", [], true);
